...
class Unet(nn.Module):
    def __init__(self, in_channel=3, conv1d=False):
        super(Unet, self).__init__()

        self.down1 = self.conv_stage(in_channel, 64)
...
class UnetMoreLayers(nn.Module):
    def __init__(self, in_channel=3, conv1d=False):
        super(UnetMoreLayers, self).__init__()

        self.down1 = self.conv_stage(in_channel, 8)
